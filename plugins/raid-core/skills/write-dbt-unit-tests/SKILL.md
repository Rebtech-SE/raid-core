---
name: write-dbt-unit-tests
description: >-
  Use when adding unit tests for a dbt model or practicing test-driven development (TDD)
  in dbt. Creates unit test YAML definitions that mock upstream model inputs and
