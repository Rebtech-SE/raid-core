...
Requires python-pptx, which is optional: only PowerPoint conversion needs it.
Install it into the project's virtualenv, never system-wide.
"""
...
try:
    ...
    sys.exit(
        "error: python-pptx is not installed. It is needed only to convert a .pptx.\n"
        "Install it into the project's virtualenv (.venv; create one if none exists):\n"
