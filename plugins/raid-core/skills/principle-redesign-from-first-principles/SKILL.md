...
description: "Use when integrating a new requirement into an existing design. Redesign as if the requirement had been foundational from day one, rather than bolting it on."
